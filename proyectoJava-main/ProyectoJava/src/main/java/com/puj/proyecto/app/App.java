                ...
                switch (opcion) {
                    case 1:
                        ...
                        if (subopcion == 1) {
                            ...
                            try {
                                com.puj.proyecto.persistencia.ManejoArchivos.cargarClientesTxt(rutaArchivo, (Empresa) javeMovil);
                            } catch (Exception e) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        System.out.println("reporte de facturacion pospago");
                        System.out.print("Ingrese el año: ");
                        int añoRespuesta = sc.nextInt();
                        System.out.print("Ingrese el mes (1-12): ");
                        int mesRespuesta = sc.nextInt();
                        System.out.println("Clientes registrados:");
                        for (cliente c : javeMovil.getClientes()) {
                            System.out.println("  " + c.getIdentificacion() + " - " + c.getNombre());
                        }
                        System.out.print("Ingrese la identificación del cliente: ");
                        long idRespuesta = sc.nextLong();
                        javeMovil.mostrarReportePostpago(idRespuesta, mesRespuesta, añoRespuesta);
                        break;
                    case 6:
                        System.out.println("consulta de reportes prepago");
                        System.out.print("Ingrese el número del mes a consultar (1-12): ");
                        int mesRespuesta2 = sc.nextInt();
                        System.out.print("Ingrese el año a consultar: ");
                        int añoRespuesta2 = sc.nextInt();

                        javeMovil.mostrarReportePrepago(mesRespuesta2, añoRespuesta2);
                        break;
                    case 7:
